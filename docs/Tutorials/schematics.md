...
![TestBuilding](/assets/image/tutorial/testbuilding.png)
...
![ScanPoint1](/assets/image/tutorial/scan1.png)

![ScanPoint2](/assets/image/tutorial/scan2.png)

Then click in the air to see the entire structure.

![ScanFull](/assets/image/tutorial/scan3.png)
...
![Schematic](/assets/image/tutorial/schematic.png)
...
> 
> ![Kelp field movement explanation](/assets/image/buildings/plantation/planter_kelp_explanation.png)
>
...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Seagrass       | The block directly below the water should tagged; the planter will bonemeal the tagged block itself. Red Xs are where the planter will attempt to walk. Blue Xs are the blocks that are tagged with the work tag.                                        | ![Seagrass explanation](/assets/image/buildings/plantation/planter_seagrass_explanation.png)     |
| Sea pickles    | The block directly below the water should tagged. The planter will initially place the pickles, then bonemeal the pickles to let them grow. Red Xs are where the planter will attempt to walk. Blue Xs are the blocks that are tagged with the work tag. | ![Sea Pickle explanation](/assets/image/buildings/plantation/planter_seapickles_explanation.png) |
...
![Upgradable Decos](/assets/image/tutorial/upgradabledecos.png)
